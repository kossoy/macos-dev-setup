...
echo ""
print_warning "Important: After installing new tools with volta (e.g., 'volta install yarn'),"
print_warning "you may need to reload your shell to use them immediately:"
echo "  exec zsh    # or"
echo "  source ~/.zshrc"
